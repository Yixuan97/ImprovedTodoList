...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ToDoItem item1 = new ToDoItem("MSA",d1,true); //Create a ToDoItem object named item1, it take in the title, the date and if it isImportant
        ...
        //it take in the title, the date and if it isImportant
        toDoList.add(item2);
